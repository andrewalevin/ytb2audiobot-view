...
Команда без параметров просто скачает субтитры данного ролика с таймкодами и ссылками на искодный ролик на youtube на конкретный временной момент.

Если после команды добавить слово для поиска - тогда в резщультате будут выданы фрагменты в которых встречается слово для поиска.
